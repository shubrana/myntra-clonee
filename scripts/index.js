...
onLoad();
function onLoad() {
    let bagItemsStr = localStorage.getItem('bagItems'); // Corrected typo
    bagItems = bagItemsStr ? JSON.parse(bagItemsStr) : []; // Assign parsed JSON data to bagItems
...
function addToBag(itemId) {
    ...
    localStorage.setItem('bagItems', JSON.stringify(bagItems)); // Corrected key name
    displayBagIcon();
}
